...
基于实验6成功经验，使用WikiText-103(180万样本)
"""
...
CONFIG = {
    'device': 'cuda',
    'max_seq_length': 256,  # 减少以适应更大数据
    'vocab_size': 10000,
    'hidden_dim': 768,
    'state_dim': 128,
    'num_layers': 6,
    'dropout': 0.1,
    'batch_size': 128,  # 更大batch
    'num_epochs': 3,   # 数据量大，3个epoch即可
...
def train():
    ...
    for epoch in range(CONFIG['num_epochs']):
        ...
        if avg_val_loss < best_val_loss:
            ...
            save_file = Path(CONFIG['save_path']) / "best_model_exp7.pt"
            torch.save({
